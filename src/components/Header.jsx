    ...
    return (
        <header className='fixed bg-white top-0 left-0 m-auto max_padd_container w-full bg-transparent ring-1 ring-slate-900/5 z-10'>
            ...
            <div className=' flexBetween py-3 max-xs:px-2'>
                {/* logo */}
                <div>
                    <Link to={'/'}><img src={Logo} alt='logo' height={77} width={77}></img></Link>
                </div>
                    ...
                    {!isMenueOpened ? (
                        ...
                        <div className='flexBetween sm:gap-x-6 cursor-pointer'>
                            ...
                            <NavLink to={'cart-page'} className={'flex'}>
                                <LiaShoppingCartSolid className='p-1 w-8 h-8 ring-slate-900/30 ring-1 rounded-full'/>
                            ...
                            <NavLink to={'login'} className={'btn_secondary_rounded flexCenter gap-x-2 medium-16'}>Login</NavLink>
